...
<div class="row">
            ...
            <table class="table table-striped table-bordered table-hover text-center" id="myTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      @if($pokok->status == 0) -
                      @elseif($pokok->status == 1) <i class="fa fa-check font-green-jungle" data-toggle="tooltip" title="Paid">Lunas</i>
                      @elseif($pokok->status == 2) <i class="fa fa-refresh font-dark" data-toggle="tooltip" title="Waiting for confirmation"></i>
                      @elseif($pokok->status == 3) <i class="fa fa-times font-red" data-toggle="tooltip" title="Not Paid"></i>
                      @endif
                    </td>
  ...
  <div class="col-md-12">
    <div class="portlet light portlet-fit portlet-datatable bordered">
      ...
      <div class="portlet-body">
        <button onclick="bayar2()" class="btn btn-primary btn-flat"><i class="fa fa-upload"></i> Bayar Iuran Pokok</button>
      </div>
    </div>
  </div>
</div>
